...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='#'"><span class="glyphicon glyphicon-edit pull-left"></span> Customers </button></li>
  ...
  <ul class="dropdown-menu" style="width:240px">
    <li><a href="brass_list.php"><strong>Brass </strong> </a></li>
 <li><a href="bm_list.php"><strong> Black Metal</strong></a></li>
   </ul></li>
...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-danger" onClick="location.href='../logout_script.php'"><span class="glyphicon glyphicon-off pull-left">
