...
<?php 
$result=mysqli_query($con,"select order_id, product_name, first_name, mobile, email, address1, product_price, qty from orders,products,users where orders.product_id=products.product_id and user_info.user_id=orders.user_id Limit $page1,10")or die ("query 1 incorrect.....");
